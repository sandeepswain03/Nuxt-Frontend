...
<script>
  ...
  export default {
    setup(){
      ...
      return {countryList, phoneList, langCode, setCountryList, location, unAuthGet,
        fetchLocation, setToastMessage, setToastError, setPhoneList, userAddressAction, profile,
        getUserToken}
    },
